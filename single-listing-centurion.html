...
<div class="container">
  ...
  <div class="row">
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" style="width: 80%; margin:auto">
          <div class="carousel-item active">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion1.jpg" alt="The Centurion Image 1">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion2.jpg" alt="The Centurion Image 2">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion3.jpg" alt="The Centurion Image 3">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion4.jpg" alt="The Centurion Image 4">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion5.jpg" alt="The Centurion Image 5">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion6.jpg" alt="The Centurion Image 6">
          </div>
          <div class="carousel-item">
            <img class="d-block w-100 img-thumbnail img-fluid max-width: 100%" src="img-the-centurion/centurion7.jpg" alt="The Centurion Image 7">
          </div>
        </div>
    ...
    <div class="col-sm-6">
      <h4>The Centurion</h4>
      <p class="light-gray-text">1240 W. 29th St., Los Angeles, CA 90007</p>


      <p><span class="space-info">Price:</span> $1100-$1400</p>
      <p><span class="space-info">Duration:</span> 1-year</p>
      <p><span class="space-info">Space Type:</span> Studio | 1Br</p>
      <p><span class="space-info">Management:</span> Stuho</p>
      <p><span class="space-info">Contact:</span> leasing@stuho.com (323.731.1034)</p>
      <p><span class="space-info">Description:</span> Nearby the new University Village and the Lyon Center, the Centurion is in a prime, north USC campus location. This property features large, convenient modern studios that are the perfect fit for your housing needs. Some apartments will be completely renovated to feature the latest and greatest in modern living comforts: hardwood style flooring, AC units, and a brand new kitchens with sleek stainless steel appliances.</p>
